/**
 * Colombia's official DIVIPOLA 2024 department and municipality catalog.
 * Source: DANE geographic service, municipality layer 317.
 */
export const COLOMBIA_LOCATIONS: Readonly<Record<string, readonly string[]>> = {
    AMAZONAS: [
        'LETICIA',
        'EL ENCANTO',
        'LA CHORRERA',
...
export const COLOMBIA_DEPARTMENTS = Object.keys(COLOMBIA_LOCATIONS)
